...
namespace Hackathon.Foundation.DependencyInjection
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddApiControllersInCurrentAssembly(this IServiceCollection serviceCollection, params string[] classFilters)
        {
            AddApiControllers(serviceCollection, Assembly.GetCallingAssembly());
        }
        ...
        public static void AddApiControllers(this IServiceCollection serviceCollection, string[] assemblyFilters, params string[] classFilters)
        {
            serviceCollection.AddApiControllers(GetAssemblies(assemblyFilters), classFilters);
        }
